...
public class Order {
    ...
    private int id; // 주문 PK   
    private int userId; // 주문자 (FK)    
    private Integer itemId; // 상품 ID (FK)    
    private String itemTitle; // 상품명 (Items 테이블 JOIN)
    private Integer price; // 판매 금액    
    private Integer amount; // 수량
    private Integer totalPrice; // 총 주문 금액    
    private String transactionType; // 거래 유형 (배송/직거래)    
    private String paymentMethod; // 결제 수단    
    private String recipientName; // 수령인 이름    
    private String recipientPhone; // 수령인 연락처    
    private String deliveryZipcode; // 배송지 우편번호    
    private String deliveryAddressMain; // 배송지 주소(기본)    
    private String deliveryAddressDetail; // 배송지 주소(상세)
