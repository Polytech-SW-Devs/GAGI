	...
	<main>
		<div class="find-container">
			<section class="find-section">
				...
				<form action="<c:url value='/findPw'/>" method="post" class="find-form">
					...
					<div class="button-group">
						...
						<input type="button" value="로그인" class="btn btn-secondary" onclick="location.href='<c:url value='/login'/>'"/>
					</div>
				</form>
			</section>
		</div>
